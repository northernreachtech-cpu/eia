          ...
          (isMobile ? (
            createPortal(
              <>
                ...
                <div className="fixed top-20 right-4 left-4 z-[100] mx-auto">
                  <Card className="min-w-0 w-full max-w-md p-6 shadow-2xl border border-white/20 bg-black/90 backdrop-blur-xl">
